    ...
    with col_centered[1]:
        ...
        if st.session_state.ver_agendar_publico:
            ...
            if tipo_reserva_pub == "A Domicilio":
                       texto_wsp = f"🏠 NUEVA CITA A DOMICILIO - Cliente: {cli_pub}, Tel: {tel_pub}, Barbero: {barbero_pub}, Servicio: {serv_pub}, Dir: {dir_pub}, Fecha: {fecha_hora_str}" if tipo_reserva_pub == "A Domicilio" else f"💈 NUEVA CITA EN LOCAL - Cliente: {cli_pub}, Tel: {tel_pub}, Barbero: {barbero_pub}, Servicio: {serv_pub}, Fecha: {fecha_hora_str}"
